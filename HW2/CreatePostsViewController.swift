...
class CreatePostsViewController: UIViewController{
    ...
    private lazy var photoLabel: UILabel = {
        ...
        photoText.font = UIFont.systemFont(ofSize: 17, weight: .medium)
    ...
    private func setupLayout() {
        ...
        NSLayoutConstraint.activate([
            ...
            titlePost.heightAnchor.constraint(equalToConstant: 50),
            ...
            textPost.heightAnchor.constraint(equalToConstant: 150),
