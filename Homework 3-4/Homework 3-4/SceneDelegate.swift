...
class SceneDelegate: UIResponder, UIWindowSceneDelegate {
    ...
    func scene(_ scene: UIScene, willConnectTo session: UISceneSession, options connectionOptions: UIScene.ConnectionOptions) {
        ...
        watchListViewController.tabBarItem = UITabBarItem(title: "", image: UIImage(systemName: "star.fill"), tag: 1)
        let watchListNavigationController = UINavigationController(rootViewController: watchListViewController)
        
        tabBarController.viewControllers = [homeNavigationController, watchListNavigationController]
